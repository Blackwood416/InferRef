...
# Contract Schema v0.1 section 4: at least two /-separated segments (a/v1 is
# the minimum), every non-version segment matches [a-z0-9][a-z0-9-]*, and the
# final segment is "v" followed by one or more digits.
